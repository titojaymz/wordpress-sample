	...
	<div class="grid_6">
        <input type="hidden" id="<?php echo $id; ?>_1" name="layout_grids[<?php echo $holder; ?>_rows][<?php echo $id; ?>][grid_1]" value="6">
	...
	<div class="grid_6">
        <input type="hidden" id="<?php echo $id; ?>_2" name="layout_grids[<?php echo $holder; ?>_rows][<?php echo $id; ?>][grid_2]" value="6">
