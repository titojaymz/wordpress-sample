	...
	<div class="grid_4">
        <input type="hidden" id="<?php echo $id; ?>_2" name="layout_grids[<?php echo $holder; ?>_rows][<?php echo $id; ?>][grid_2]" value="4">
	...
	<div class="grid_4">
        <input type="hidden" id="<?php echo $id; ?>_3" name="layout_grids[<?php echo $holder; ?>_rows][<?php echo $id; ?>][grid_3]" value="4">
